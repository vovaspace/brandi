...
export const isInstanceBinding = (binding: Binding): binding is InstanceBinding =>
  binding.type === Type.Instance;

export const isContainerScopedInstanceBinding = (
  binding: InstanceBinding,
): binding is ContainerScopedInstanceBinding => binding.scope === Scope.Container;

export const isResolutionScopedInstanceBinding = (
  binding: InstanceBinding,
): binding is ResolutionScopedInstanceBinding => binding.scope === Scope.Resolution;

export const isSingletonScopedInstanceBinding = (
  binding: InstanceBinding,
): binding is SingletonScopedInstanceBinding => binding.scope === Scope.Singleton;
